...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        default='',
        help=
        "Position lists, e.g. 11 12 14 18, 1 2 3 4 for first chain and the second chain"
    )
    argparser.add_argument(
        "--homooligomer",
        type=int,
    ...
    argparser.add_argument(
        ...
        default='',
        help=
        "Chain beta list for the chain lists provided; 1.0 for the positive design, -0.1 or -0.5 for negative, 0.0 means do not use that chain info"
    )
